...
if __name__ == '__main__':
    data_wash(cfg.o_trainSet, cfg.o_trainJson, r'./o_train_purified.json', cfg.o_trainWasted)
    # data_wash(cfg.o_valSet, cfg.o_valJson, r'./o_val_purified.json', cfg.o_valWasted)
