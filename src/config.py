...
parser.add_argument('--lr_reduction_factor', type=float, default=0.001)
...
parser.add_argument('--training_model_cp_filename', type=str, default=r'./model/model.{epoch:03d}-{loss:.2f}.h5')
parser.add_argument('--prediction_model_cp_filename', type=str, default=r'./model/prediction_model.{epoch:03d}.h5')
